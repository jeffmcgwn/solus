/*
  ==============================================================================
    ...
    CleanGateComponent.h
    Created: 18 Mar 2024 6:29:58pm
    Author:  Jeff
...
class CleanGateComponent : public juce::Component
{
public:
    CleanGateComponent(LameAmpAudioProcessor& p);
    ~CleanGateComponent() override;
